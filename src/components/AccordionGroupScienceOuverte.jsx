 ...
 * @param {('bleuPrincipal'|'rose'|'vertPale')} [props.color='bleuPrincipal'] - Thème de couleur pour le groupe d'accordéons. Valeurs possibles: 'bleuPrincipal' ou 'rose'
 ...
 */
export default function AccordionGroupScienceOuverte({ color = 'vertPale', children, ...props }) {
