...
import { EnvelopeSimple, ChatsCircle, Phone, MicrosoftTeamsLogoIcon } from '@phosphor-icons/react'
    ...
    <ThemeProvider theme={theme}>
      <Container maxWidth="xl" sx={{ px: { xs: 2, sm: 4 }, py: 4 }}>
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} sx={{ mb: 3 }}>
            ...
            >
              <MenuItem value=""><em>Toutes les bibliothèques ou directions</em></MenuItem>
