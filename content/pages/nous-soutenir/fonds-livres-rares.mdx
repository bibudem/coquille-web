...
## Le trésor des bibliothèques UdeM
...
> 
<Grid size={3}>
<img src={Cartons} style={{width: 'auto', height: '200px', borderRadius: '12px'}} alt="" />
Cartons d'invitation à des vernissages d'expositions
</Grid>
<Grid size={3}>
<img src={Corrections} style={{width: 'auto', height: '200px', borderRadius: '12px'}} alt="" />
Corrections manuscrites d’un ancien propriétaire
</Grid>
<Grid size={3}>
<img src={Illustration} style={{width: 'auto', height: '200px', borderRadius: '12px'}} alt="" />
...
- Restauration d'une affiche ancienne : 1 500 $ -3000 $
